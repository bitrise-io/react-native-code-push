// Ported from https://github.com/microsoft/code-push/blob/master/src/test/acquisition-sdk.ts (archived, MIT licensed)
...
import { CodePushPackageError } from "../code-push-error"
